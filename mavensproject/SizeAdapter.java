...
import com.example.mavensproject.databinding.ViewholderSizeBinding;
...
public class SizeAdapter extends RecyclerView.Adapter<SizeAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull SizeAdapter.Viewholder holder, int position) {
        holder.binding.sizeText.setText(items.get(position));
        ...
        if(selectedPosition==holder.getAdapterPosition()) {
            ...
            holder.binding.sizeText.setTextColor(context.getResources().getColor(R.color.blue));
        }else {
            holder.binding.sizeLayout.setBackgroundResource(R.drawable.size_unselected);
            holder.binding.sizeText.setTextColor(context.getResources().getColor(R.color.black));
        }
